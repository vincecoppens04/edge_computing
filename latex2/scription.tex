...
% PAGE LAYOUT
% =====================================================
\usepackage[a4paper,left=21mm,right=21mm,top=26mm,bottom=25mm,includefoot]{geometry}
...
% Front matter and TOC removed for simplified version
\pagestyle{plain}
\clearpage
...
\mainchapter{Kubernetes and its relevance to edge computing}
\input{kubernetes}

\mainchapter{AWS Lambda and its relevance to edge computing}
\input{lambda}

\mainchapter{Private 5G and its relevance to edge computing}
\input{private_5g}
...
% Appendices removed for simplified version
