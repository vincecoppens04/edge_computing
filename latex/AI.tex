...
The scale of device proliferation (see Appendix~\ref{app:ai_figures}, Figure~\ref{fig:ai-iot-growth}) makes it evident that centralized processing is no longer feasible. Computation must move closer to where data is produced.
...
The growth of the Edge AI market — from \$20.8~billion in 2024 to \$66.5~billion by 2030 — reflects not investor sentiment, but a systemic shift driven by these technological constraints~\cite{grandview-edge-ai-market}. 
